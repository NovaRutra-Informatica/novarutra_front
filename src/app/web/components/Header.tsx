        ...
        >
            ...
            >
                <div className="flex h-full lg:flex-1">
                    <a
                        href="#inicio"
                        className="-m-1.5 h-10 items-center flex justify-center center p-1.5"
                    >
                        <img
                            className="h-28 overflow-hidden w-auto"
                            src={NovaRutraLogo}
                            alt="NovaRutra Informática"
                        />
                    </a>
                </div>
                <div className="hidden lg:flex lg:gap-x-12">
                    {navLinks.map((item) => (
                        <a
                            key={item.name}
                            href={item.href}
                            className="text-sm font-semibold leading-6 text-white hover:text-novarutra-yellow transition-all duration-300 hover:scale-110"
                        >
                            {item.name}
                        </a>
                    ))}
