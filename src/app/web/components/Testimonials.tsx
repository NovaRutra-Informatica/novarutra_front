                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="mx-auto max-w-2xl text-center">
                        ...
                        <p className="mt-6 text-lg leading-8 text-gray-600">
                            Resultados e confiança construídos através de um
                    ...
                    <div className="relative">
                        ...
                        <button
                            onClick={scrollPrev}
                            className="absolute left-0 top-1/2 -translate-y-1/2 rounded-full bg-novarutra-blue/20 p-2 text-novarutra-blue hover:bg-novarutra-blue/40 transition-all duration-300 hover:scale-110 active:scale-100"
                        >
                            <ChevronLeftIcon className="h-6 w-6" />
                        </button>
                        <button
                            onClick={scrollNext}
                            className="absolute right-0 top-1/2 -translate-y-1/2 rounded-full bg-novarutra-blue/20 p-2 text-novarutra-blue hover:bg-novarutra-blue/40 transition-all duration-300 hover:scale-110 active:scale-100"
                        >
